...
<head>
	...
	<!-- DESCRIPTION -->
	<meta name="description" content="Fatima Convent Senior Secondary" />

	<!-- OG -->
	<meta property="og:title" content="Fatima Convent Senior Secondary" />
	<meta property="og:description" content="Fatima Convent Senior Secondary" />
	<meta property="og:image" content="" />
	<meta name="format-detection" content="telephone=no">

	<!-- FAVICONS ICON ============================================= -->
	<link rel="icon" href="assets/images/favicon.ico" type="image/x-icon" />
	<link rel="shortcut icon" type="image/x-icon" href="assets/images/school__logo-removebg-preview.png" />
	...
	<title>Fatima Convent Senior Secondary School </title>
...
<body id="bg">
	<div class="page-wraper">
					...
					<div class="row d-flex justify-content-between">
						...
						<div class="topbar-right">
							<ul>
								...
								<!-- <li><a href="login.html"><i class="ti-new-window loginbar"></i> Login</a></li>  -->
			...
			<div class="sticky-header navbar-expand-lg">
				<div class="menu-bar clearfix">
					<div class="container clearfix">
						<!-- Header Logo ==== -->
						<div class="menu-logo">
							<a href="index.html"><img src="assets/images/school__logo-removebg-preview.png"
									alt="School_Logo"></a>
							<a href="index.html"><img src="assets/images/fatima_name_logo_edited-removebg-preview.png"
									class="logo-width" alt="School_Logo"></a>
							<!-- <div class="logo-width"><a href="index.html"></a></div> -->
						</div>
						<!-- Mobile Nav Button ==== -->
						...
						<div class="secondary-menu">
							<div class="secondary-inner">
								<ul>
									<li><a href="login.html" class="btn-link "><i class="ti-new-window loginbar"></i>
											Login</a></li>
									<li><a href="javascript:;" class="btn-link search-btn"><i
						...
						<div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
							<div class=" logo" id="logo1">
								<a href="index.html"><img src="assets/images/school__logo-removebg-preview.png" alt=""
										width="60"></a>
							</div>
							<ul class="nav navbar-nav">
								...
								<li class="add-mega-menu"><a href="javascript:;">Academics<i
											class="fa fa-chevron-down"></i></a>
									<ul class="sub-menu add-menu">
										<li class="add-menu-left">
											<h5 class="menu-adv-title">Academics</h5>
											<ul>
												<li><a href="courses.html">Admission Details</a></li>
												<li><a href="courses-details.html">Fee Structure</a></li>
												<li><a href="profile.html">Result</a></li>
								...
								<li class="nav-dashboard"><a href="javascript:;">Administration<i
											class="fa fa-chevron-down"></i></a>
									<ul class="sub-menu">
										<li class="add-menu-left">
											<h5 class="menu-adv-title">School Administration</h5>
										</li>

										<li><a href="/">School Committee</a></li>
										<li><a href="/">Staff Details</a></li>
										<li><a href="/">Staff Vacancy</a></li>
		...
		<div class="page-content bg-white">
					...
					<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;"
						...
						<ul> <!-- SLIDE  -->
							<li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default"
								...
								data-description="Universe is expanding">
								<!-- MAIN IMAGE -->
								...
								<div class="tp-caption tp-shape tp-shapewrapper " id="slide-100-layer-1"
									...
									style="z-index: 5;background: rgba(71, 70, 80, 0.452);border-color:rgba(0, 0, 0, 0);border-width:0px;">
								</div>
								<!-- LAYER NR. 2 -->
								...
								<div class="tp-caption Newspaper-Button rev-btn" id="slide-100-layer-6"
									...
									<a href="/about-1.html">Take a tour</a>
								</div>
							</li>
							<li data-index="rs-200" data-transition="parallaxvertical" data-slotamount="default"
								...
								data-param9="" data-param10="" data-description="Universe is expanding">
								<!-- MAIN IMAGE -->
			...
			<div class="content-block">
				...
				<!-- Popular Courses -->
				<div class="section-area section-sp2 popular-courses-bx mission_vision  ">
					<div class="container">
						<div class="row">
							<div class="col-md-12 heading-bx left">
								<h2 class="title-head      Left" >Our <span>Vision </span></h2>
								<p class="  Left">To cater to the educational needs of the children of
									transferable Central Government
									employees including Defence and Para-Military personnel by providing a common
									programme of education.To pursue excellence and set the pace in the field of school
									education.</p>
								<p class="    Left">To initiate and promote experimentation and innovativeness
									in education in
									collaboration with other bodies like the Central Board of Secondary Education and
									the National Council of Educational Research and Training etc.</p>
								<div class="p-t50">

									<h2 class="title-head p-t0      Left ">Our <span>Mission
										</span></h2>

									<p class=" ">To initiate and promote experimentation and innovativeness in
										education in
										collaboration with other bodies like the Central Board of Secondary Education
										and the National Council of Educational Research and Training etc.</p>
					...
					<div class="container ">
						<div class="row">
							<div class="col-md-12 text-center text-white">
								<h2 class="principal_title      Down">Principal's Message</h2>
								<h5 class="principal_title      DownBig">Below down is the message from our principal
								</h5>
								<div class="gdlr-core-text-box-item-content"
									style="font-size: 16px ;font-weight: 400 ;text-transform: none ;color: #d7d6ff ;">

									<em><strong style="color: #fff; 
										"><img class="alignleft principal_img      Left"
												src="https://donboscoguwahati.net/wp-content/uploads/2021/06/Principal-message-pic2-1024x682.jpg?x51994"
												style="width: 430px; height: 300px; position: relative; left: 18px; "
												alt="principal_img">
											<p id="msg1" class="msg_1p      RightBig">Dear
												Friends,</p>
										</strong></em><br>
									<p class="principal_msg      ">Welcome to Fatima Convent Senior Secondary
										School , Rangia!</p>
									<p class="principal_msg      ">I gladly welcome all of you to our enriching website,
										which I
										am sure will serve as an essential interactive tool for all
										of you to acquaint yourselves with the large and extended
										FCSS family.</p>
									<p class="principal_msg     ">Over more than seven decades of relentless academic
										endeavour
										and brilliance, our school has become a much sought after
										educational institution that…</p>
									<p class="principal_msg     "><button class="btn"><a href="/about-1.html"
												style="font-size: 15px; color: #ffffff; padding: 12px 15px 17px 15px; text-transform: none; border-radius: 2px; -moz-border-radius: 2px; -webkit-border-radius: 2px;">
				...
				<div class="section-area section-sp2 ">
					<div class="container">
						<div class="row">
							<div class="col-md-12 text-center heading-bx Down">
								<h2 class="title-head m-b0 event-titls">Upcoming <span>Events</span></h2>
								<p class="m-b0 event-titls">Upcoming Education Events To Feed Brain. </p>
							</div>
						</div>
						<div class="row">
							<div
						...
						<div class="text-center ">
							<a href="#" class="btn btn_event">View All Event</a>
						</div>
					</div>
				</div>
		...
		<footer>
					...
					<div class="container">
						<div class="d-flex align-items-stretch">
							<div class="pt-logo mr-auto">
								<a href="index.html"><img src="assets/images/fatima_name_logo-removebg-preview.png"
										alt="" /></a>
							</div>
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 text-center text-white">Developed,Designed &
							Maintained By &lt;/Tensor_Block&gt;</div>
					</div>
				</div>
			</div>
		</footer>
	...
	<script>
				...
				// ScrollReveal(`.principal_title`,{ origin: 'left', delay: 2000});
	</script>
